		...
		<Card>
			...
			<Form ref="rmrsUserForm" :model="rmrsUserForm" :label-width="100" label-position="right" :rules="inforValidate">
				...
				<Row>
					<Col :lg='6'>&nbsp;</Col>
					<Col :lg='12'>
					<FormItem label="扣费金额：" prop="charge">
						<div>
							<Input v-model="rmrsUserForm.charge"></Input>
						</div>
					</FormItem>
					</Col>
				</Row>
				<Row>
					<Col :lg='6'>&nbsp;</Col>
					<Col :lg='12'>
					<FormItem label="扣费说明：" prop="description">
						<div>
				...
				<Row>
					<Col :lg='16'>&nbsp;</Col>
					<Col :lg="2">
					<Button type="success" long @click="rmrsUserPay">确认扣费</Button>
					</Col>
				</Row>
			</Form>
		</Card>
		...
		methods: {
			...
			rmrsUserPay() {
				...
				this.$refs['rmrsUserForm'].validate((valid) => {
					if(valid) {
						axios.post(Api.url + 'hems/customers/customerCharge', {
							userId: copy.rmrsUserForm.userid,
							charge: copy.rmrsUserForm.charge,
