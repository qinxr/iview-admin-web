			...
			<Card>
				...
				<Row>
					...
					<Card>
						...
						<Row style="text-align: center;">
							<Col :lg="8">
							<Tag type="border" color="green">1</Tag>
							</Col>
							<Col :lg="8">
							<Tag type="border" color="green">1</Tag>
							</Col>
							<Col :lg="8">
							<Tag type="border">0</Tag>
							</Col>
						</Row>
						<Row style="text-align: center;">
							<Col :lg="8">
					...
					<Card>
						...
						<Row style="text-align: center;">
							<Col :lg="8">
							<Row>
								<Tag type="border" color='blue'>1#冷冻泵</Tag>
							</Row>
							<Row>
								&nbsp;
							</Row>
							<Row>
								<Tag type="border">额定功率 22kw</Tag>
							</Row>
							<Row>
								<Tag type="border">额定流量 160m³/h</Tag>
							</Row>
							</Col>
							<Col :lg="8">
							<Row>
								<Tag type="border" color='blue'>2#冷冻泵</Tag>
							</Row>
							<Row>
								&nbsp;
							</Row>
							...
							<Col :lg="8">
							<Row>
								<Tag type="border" color='blue'>3#冷冻泵</Tag>
							</Row>
							<Row>
								&nbsp;
							</Row>
