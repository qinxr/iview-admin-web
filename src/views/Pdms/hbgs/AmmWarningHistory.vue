	...
	export default {
		...
		methods: {
			...
			del() {
				...
				axios.post(Api.url + "pdms/warning/deletePmWarning", {
						id: id
					}, {
						headers: {
...
//						}
			...
			Init() {
				const copy = this;
				this.$http.get(Api.url + 'pdms/warning/getPmWarnings/' + Api.hbgsId, {
						headers: {
							Authorization: "Bearer " + localStorage.getItem("access_token")
						}
					})
			...
			Refer() {
				...
				this.$http.get(Api.url + 'pdms/warning/getPmWarnings/' + Api.hbgsId + '/' + start + '/' + stop, {
						headers: {
							Authorization: "Bearer " + localStorage.getItem("access_token")
						}
					})
