                	...
                	<Row>
	                	...
	                	<Col :lg='12'>
			                <FormItem label="区域选择：" prop="regionId">
			                    <div >
			                        <Select slot="append" v-model="pdRoomForm.regionId"  @on-change='getBuilding(pdRoomForm.regionId)'>
		            ...
		            <Row>
	                	...
	                	<Col :lg='12'>
			                <FormItem label="建筑物选择：" prop="buildingId">
			                    <div >
			                        <Select slot="append" v-model="pdRoomForm.buildingId">
		...
		methods: {
			...
			Save () {
				...
				this.$http.post(Api.url + 'pdms/rooms/addRoom', {
					...
					buildingId: copy.pdRoomForm.buildingId,
