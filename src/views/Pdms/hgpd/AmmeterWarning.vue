            ...
            <Card>
                <p slot="title">
	                <Icon type="ivu-icon ivu-icon-alert-circled"></Icon>
				           电表告警订阅
				    <router-link to="/Pdms/hgpd/projectManagement/ammeterWarningAdd" class="pdRoom-add">
...
<script>
	export default {
		...
		mounted () {
			const copy = this;
			//获取电表告警信息
			this.$http.get(Api.url + 'pdms/pmWarningSub/getPmWarningSubAsProject/' + Api.pdId, {
				headers: {
