	...
	<Row class="margin-top-10">
		...
		<Card>
			<p slot="title">
				...
				环境管理
				<Button type="info" style="margin-left: 20px;"><router-link to="/Pdms/hgpd/projectManagement/environmentAdd" class="user-add"><Icon type="plus-round"></Icon>&nbsp;&nbsp;环境信息新增</router-link></Button>
			</p>
			<div class="edittable-table-height-con">
				...
				<Table refs="table" :data="transformerData" v-model="transformerData" :columns="editInlineColumns"></Table>
...
<script>
	...
	export default {
		...
		mounted() {
			const copy = this;
			//获取全部环境信息
			this.$http.get(Api.url + "pdms/env/getEnvAsProject/"+Api.pdId, {
					headers: {
