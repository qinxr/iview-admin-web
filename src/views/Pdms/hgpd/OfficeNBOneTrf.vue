		...
		<Row>
			<Card>
				<Row>
					...
					<Col :lg="3">
						<Cascader :data="data" v-model="value1" @on-change="switchover" filterable not-found-text="请选择要查看的变压器名称"></Cascader>
					</Col>
				</Row>
			</Card>
		</Row>
	...
	export default {
		...
		data() {
			return {
                ...
                data: [{
                    ...
                    children: [
                        {
                            value: 'hgpdofficeNBOneTrf',
                            label: '1#变压器'
                        },
                        {
                            value: 'hgpdofficeNBTwoTrf',
                            label: '2#变压器'
                        },
                        {
                            value: 'hgpdofficeNBThreeTrf',
                            label: '3#变压器'
                        },
                        {
                            value: 'hgpdofficeNBFourTrf',
                            label: '4#变压器'
                        },
                        {
                            value: 'hgpdofficeNBFiveTrf',
                            label: '5#变压器'
                        },
                        {
                            value: 'hgpdofficeNBSixTrf',
                            label: '6#变压器'
                        },
                    ]
                }],
				...
				searchConName1: "",
				svg: {
					'src': require("../../../images/ACLP/42.svg")
				},
				trfData: [],
				cNamedata1: [{
					id: '',
		...
		methods: {
			...
			Init() {
				...
				const copy = this;
				//初始化页面的数据
				this.$http.get(Api.url + 'pdms/monitor/getMonitorAsTrf/1', {
						headers: {
