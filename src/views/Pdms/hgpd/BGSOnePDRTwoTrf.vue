	...
	export default {
		...
		data() {
			return {
				...
				searchConName1: "",
				svg: {
					'src': require("../../../images/ACLP/52.svg")
				},
				trfData: [],
				cNamedata1: [{
					id: '',
		...
		methods: {
			...
			Init() {
				...
				const copy = this;
				//初始化页面的数据
				this.$http.get(Api.url + 'pdms/monitor/getMonitorAsTrf/22', {
						headers: {
					...
					.then(response => {
						...
						console.log(copy.svgData);
						for(var i = 0; i < copy.svgData.length; i++) {
							if(i < num) {
								copy.cNamedata1[0].id = 'c' + copy.svgData[i].pm_id;
								copy.cNamedata1[0].y = 167 + (i - 1) * 66;
								copy.cNamedata1[0].value = copy.svgData[i].pm_name;

								if(copy.svgData[i].pm_type == 3) {
									copy.cNamedata1[1].id = 'cia' + i;
									copy.cNamedata1[1].y = 167 + (i - 1) * 66;
									copy.cNamedata1[1].value = 'Ia:';
									copy.cNamedata1[2].id = 'cib' + i;
									copy.cNamedata1[2].y = 167 + 20 + (i - 1) * 66;
									copy.cNamedata1[2].value = 'Ib:';
									copy.cNamedata1[3].id = 'cic' + i;
									copy.cNamedata1[3].y = 167 + 40 + (i - 1) * 66;
									copy.cNamedata1[3].value = 'Ic:';
									if(copy.svgData[i].status != 1) {
										//数值绑定
										copy.cValuedata1[0].y = 167 + (i - 1) * 66;
										copy.cValuedata1[0].value = '离线';
										copy.cValuedata1[0].color = 'gray';
	
										copy.cValuedata1[1].y = 167 + 20 + (i - 1) * 66;
										copy.cValuedata1[1].value = '离线';
										copy.cValuedata1[1].color = 'gray';
	
										copy.cValuedata1[2].y = 167 + 40 + (i - 1) * 66;
										copy.cValuedata1[2].value = '离线';
										copy.cValuedata1[2].color = 'gray';
									} else {
										//数值绑定
										copy.cValuedata1[0].y = 167 + (i - 1) * 66;
								...
								if(copy.svgData[i].pm_type == 7) {
									copy.cNamedata1[1].value = '';
									copy.cNamedata1[2].id = 'ci' + i;
									copy.cNamedata1[2].y = 167 + 20 + (i - 1) * 66;
									copy.cNamedata1[2].value = 'I:';
									copy.cNamedata1[3].value = '';
									if(copy.svgData[i].status != 1) {
										//数值绑定
										copy.cValuedata1[0].value = '';
										copy.cValuedata1[1].y = 167 + 20 + (i - 1) * 66;
										copy.cValuedata1[1].value = '离线';
										copy.cValuedata1[1].color = 'gray';
										copy.cValuedata1[2].value = '';
									} else {
										//数值绑定
										copy.cValuedata1[0].value = '';
										copy.cValuedata1[1].y = 167 + 20 + (i - 1) * 66;
										copy.cValuedata1[1].value = copy.svgData[i].ia;
										copy.cValuedata1[1].color = 'blue';
										copy.cValuedata1[2].value = '';
									}
								}
								...
								copy.cNamedata2[0].y = 100 + (i - num) * 66;
								copy.cNamedata2[0].value = copy.svgData[i].pm_name;
								if(copy.svgData[i].pm_type == 3) {
									copy.cNamedata2[1].id = 'cia' + i;
									copy.cNamedata2[1].y = 102 + (i - num) * 66;
									copy.cNamedata2[1].value = 'Ia:';
									copy.cNamedata2[2].id = 'cib' + i;
									copy.cNamedata2[2].y = 102 + 20 + (i - num) * 66;
									copy.cNamedata2[2].value = 'Ib:';
									copy.cNamedata2[3].id = 'cic' + i;
									copy.cNamedata2[3].y = 102 + 40 + (i - num) * 66;
									copy.cNamedata2[3].value = 'Ic:';
									if(copy.svgData[i].status != 1) {
										copy.cValuedata2[0].y = 102 + (i - num) * 66;
										copy.cValuedata2[0].value = '离线';
										copy.cValuedata2[0].color = 'gray';
	
										copy.cValuedata2[1].y = 102 + 20 + (i - num) * 66;
										copy.cValuedata2[1].value = '离线';
										copy.cValuedata2[1].color = 'gray';
	
										copy.cValuedata2[2].y = 102 + 40 + (i - num) * 66;
										copy.cValuedata2[2].value = '离线';
										copy.cValuedata2[2].color = 'gray';
									} else {
										//数值绑定
										copy.cValuedata2[0].y = 102 + (i - num) * 66;
								...
								if(copy.svgData[i].pm_type == 7) {
									copy.cNamedata2[1].value = '';
									
									copy.cNamedata2[2].id = 'ci' + i;
									copy.cNamedata2[2].y = 102 + 20 + (i - num) * 66;
									copy.cNamedata2[2].value = 'I:';
									
									copy.cNamedata2[3].value = '';
									if(copy.svgData[i].status != 1) {
										copy.cValuedata2[0].value = '';
										
										copy.cValuedata2[1].y = 102 + 20 + (i - num) * 66;
										copy.cValuedata2[1].value = '离线';
										copy.cValuedata2[1].color = 'gray';
										
										copy.cValuedata2[2].value = '';
									} else {
										//数值绑定
										copy.cValuedata2[0].value = '';
	
										copy.cValuedata2[1].y = 102 + 20 + (i - num) * 66;
										copy.cValuedata2[1].value = copy.svgData[i].ia;
										copy.cValuedata2[1].color = 'blue';
