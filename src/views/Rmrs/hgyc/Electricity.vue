				...
				<Tabs>
                    ...
                    冻结电量
						...
						<Row>
							...
							<Input v-model="searchConName1" icon="search" @on-change="handleSearch1" placeholder="请输入用电日期搜索..." style="width: 200px" />
							</Col>
						</Row>
	...
	export default {
		...
		methods: {
			...
			init() {
				...
				axios.get(Api.url + "hems/meter/getPowerConsum/" + index, {
						headers: {
			...
			handleSearch1() {
				...
				this.customerData = this.search(this.customerData, {
					measuretime: this.searchConName1
				});
				}
			},
			//搜索功能函数
